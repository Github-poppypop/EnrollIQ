  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background text-foreground antialiased">
      <aside className="w-[260px] h-screen sticky top-0 left-0 border-r border-outline-variant bg-surface flex flex-col py-4 px-3 z-50 shrink-0">
        <div className="mb-6 px-3 flex items-center gap-3">
          ...
          <div className="min-w-0">
            <h1 className="font-headline-md text-headline-md font-bold text-on-surface leading-tight truncate">Academic Intelligence</h1>
            <p className="font-body-sm text-body-sm text-on-surface-variant leading-tight truncate">Enterprise Engine</p>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="hidden md:flex w-full sticky top-0 z-40 border-b border-outline-variant bg-surface px-6 py-4 justify-between items-center transition-all duration-200 ease-in-out">
          <div className="flex items-center gap-6">
            <div className="relative w-64 clay-card py-2 px-3 flex items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="clay-btn py-2 px-5 font-label-md text-label-md text-on-surface font-bold hover:text-secondary">
              Deploy Model
            </button>
            <div className="w-10 h-10 rounded-full border border-outline-variant bg-surface-container-low overflow-hidden">
              <img
                alt="Account"
