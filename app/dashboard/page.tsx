      ...
      <div className="flex flex-col gap-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 rounded-full border border-success/60 bg-success-container px-3 py-1 text-xs font-medium text-success">
            ...
            <button
              onClick={load}
              disabled={loading}
              className="clay-btn py-2 px-4 font-label-md text-label-md text-on-surface disabled:opacity-50 transition-colors inline-flex items-center gap-2"
            >
        ...
        <div className="relative flex gap-1 rounded-2xl bg-surface-container p-1.5">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              onClick={() => setActiveTab(tab.id)}
              className={`relative flex-1 rounded-xl px-4 py-2.5 font-label-md text-label-md transition-colors ${
            ...
            >
              ...
              {activeTab === tab.id && (
                <motion.div
                  className="absolute inset-0 rounded-xl bg-surface-container-lowest"
        ...
        <AnimatePresence mode="wait">
          {error ? (
            ...
            >
              ...
              <button onClick={load} className="mt-3 clay-btn py-2 px-4 font-label-md text-label-md text-secondary">
                Retry
              </button>
            </motion.div>
          ) : !payload ? (
                            ...
                            <ResponsiveContainer width="100%" height={320}>
                              <AreaChart data={demandData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                                ...
                                <Area
                                  ...
                                  activeDot={{ r: 7, stroke: '#22c55e', strokeWidth: 2, fill: '#1e1e1e' }}
                                ...
                                <Area
                                  ...
                                  dot={{ r: 3, fill: '#4b41e1', stroke: '#1e1e1e', strokeWidth: 2 }}
